...
public class CarDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePickerButton.setOnClickListener(v -> new DatePickerDialog(CarDetailsActivity.this, dateSetListener,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        Toast.makeText(CarDetailsActivity.this, "Failed to fetch car details: " + message, Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(CarDetailsActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CarDetailsActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String status = jsonResponse.getString("status");
                    if (status.equals("success")) {
                        Toast.makeText(CarDetailsActivity.this, "Car booked successfully!", Toast.LENGTH_SHORT).show();
                        // Optionally, navigate to booking history or another activity
                    } else {
                        String message = jsonResponse.getString("message");
                        Toast.makeText(CarDetailsActivity.this, "Booking failed: " + message, Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(CarDetailsActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
