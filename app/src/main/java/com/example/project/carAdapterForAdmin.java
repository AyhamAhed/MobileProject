...
public class carAdapterForAdmin extends RecyclerView.Adapter<carAdapterForAdmin.CarViewHolder> {
    ...
    public carAdapterForAdmin(Context context, List<Car> carList) {
    ...
    public CarViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_car_info_for_admin, parent, false);
